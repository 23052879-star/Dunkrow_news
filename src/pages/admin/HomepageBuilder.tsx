      ...
      <div className="space-y-6 animate-in fade-in duration-300">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-white dark:bg-neutral-900/40 border-gray-200 dark:border-neutral-800 space-y-4">
              ...
              <div className="space-y-1">
                <select
                  ...
                  className="w-full px-3 py-2.5 bg-gray-50 dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-xl text-sm text-gray-700 dark:text-neutral-300 focus:outline-none"
                >
            ...
            <Card className="bg-white dark:bg-neutral-900/40 border-gray-200 dark:border-neutral-800 space-y-4">
              ...
              <div className="space-y-4 pt-2">
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-500 dark:text-neutral-400 uppercase tracking-wider">Spotlight Pick 1</label>
                  <select
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-500 dark:text-neutral-400 uppercase tracking-wider">Spotlight Pick 2</label>
                  <select
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-500 dark:text-neutral-400 uppercase tracking-wider">Spotlight Pick 3</label>
                  <select
          ...
          <div className="space-y-6">
            <Card className="bg-white dark:bg-neutral-900/60 border-gray-200 dark:border-neutral-800 p-6 flex flex-col justify-between min-h-[250px]">
              <div>
                <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider border-b border-gray-200 dark:border-neutral-800 pb-2 mb-4">
                  Layout Controls
                </h3>
                <p className="text-gray-400 dark:text-neutral-500 text-xs leading-relaxed">
            ...
            <Card className="bg-white dark:bg-neutral-900/40 border-gray-200 dark:border-neutral-800 p-6 space-y-4">
              <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider flex items-center border-b border-gray-200 dark:border-neutral-800 pb-2">
