          ...
          <div className="space-y-6">
            ...
            <Card className="bg-neutral-900/40 border-neutral-850 space-y-4">
              ...
              <Button 
                variant="outline" 
                fullWidth
                className="border-neutral-850 text-neutral-300 hover:bg-neutral-950 flex justify-center"
            ...
            <Card className="bg-neutral-900/40 border-neutral-850 space-y-4">
              ...
              <div className="relative">
                <pre className="bg-neutral-950 border border-neutral-850 p-3.5 rounded-xl text-[9px] text-neutral-400 font-mono overflow-x-auto max-h-48 scrollbar-thin scrollbar-thumb-neutral-800 leading-normal">
